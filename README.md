...
- Bots may aim too perfect, the precision can be changed inside `sv_config.lua` with the option `D3bot.FaceTargetOffshootFactor`. (Suggestion for the fix by [Horde Stick])
...
[Horde Stick]: https://steamcommunity.com/profiles/76561198171603670

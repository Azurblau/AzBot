...
var flagScale = flag.Float64("scale", 0.005, "Scale of the image. Unit depends on the output format used. Raster images are based on 1 pixel / mm. Vector images are output in mm directly.")
